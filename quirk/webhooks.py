...
FILTERS = {
    ...
    'after_time': lambda e, v: datetime.fromtimestamp(e['timestamp']) >= datetime.fromisoformat(v),
    'before_time': lambda e, v: datetime.fromtimestamp(e['timestamp']) <= datetime.fromisoformat(v),
    'data_fields': lambda e, v: all(key in e['data'] and e['data'][key] == value for key, value in v.items())
}
